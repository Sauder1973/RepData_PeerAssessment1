...
```
```{r echo = FALSE}
setwd("C:\\Users\\Wes\\Documents\\RWorkingDirectory\\Reproducible Research\\Assignment1")
```
...
grp <- group_by(StepIntMeanWkDay, DaysOfWeek)
summarise(grp, mean=mean(interval),sd=sd(interval) )
